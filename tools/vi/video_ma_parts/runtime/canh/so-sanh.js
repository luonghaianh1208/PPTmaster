(function (root) {
  ...
  root.THI_CANH['so-sanh'] = {
    muc: function (du) {
      ...
      t['y-trai'].forEach(function (y, k) { kq.push(B.chu('y-trai-' + k, y, 80, 285 + k * 84, 520, 84, 28, du.moc[k], {})); });
      t['y-phai'].forEach(function (y, k) { kq.push(B.chu('y-phai-' + k, y, 700, 285 + k * 84, 520, 84, 28, du.moc[nt + k], {})); });
      return kq;
    }
  };
